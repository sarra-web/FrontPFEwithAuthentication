...
export class ProjectServiceService {
  ...
  get(id: any): Observable<Project> {
    return this.http.get<Project>(`${baseUrl}/findById/${id}`);
  }
  ...
  findByNameIgnoreCase(name: any): Observable<Project[]> {
    return this.http.get<Project[]>(`${baseUrl}/NameContainsIgnoreCase/${name}`);
  }
  findByNameContaining(params: any): Observable<any> {
    return this.http.get<any>(`${baseUrl}/projects`,{params});
  }
}
